      ...
      <div className="navbar max-w-7xl py-4 flex items-center justify-between relative">
        ...
        >
          <li>
            <Link
              to="/"
              className="text-base opacity-70 hover-opacity-100 md:opacity-100 tranition px-4 py-2 lg:px-0 lg:py-0"
            >
              Home
            </Link>
          </li>
          <li>
            <Link
              to="/about"
              className="text-base opacity-70 hover-opacity-100 md:opacity-100 tranition px-4 py-2 lg:px-0 
lg:py-0"
            >
              About
            </Link>
...
lg:py-0"
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          <div>
            ...
            <p className="font-semibold"> 811 345 6789</p>
          </div>
        </div>
      </div>
    </nav>
